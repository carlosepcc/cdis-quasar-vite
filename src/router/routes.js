const routes = [
  {
    ...
    children: [
      ...
      {name: "Comisiones Disciplinarias", path: "/comisiones", component: () => import("pages/ListPages/PageComisiones.vue"),},
      {name: "Denuncias", path: "/denuncias", component: () => import("pages/ListPages/PageDenuncias.vue")},
      {name: "Usuarios", path: "/users", component: () => import("pages/ListPages/PageUsers.vue")},
